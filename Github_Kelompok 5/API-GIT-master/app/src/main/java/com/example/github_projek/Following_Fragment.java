...
public class Following_Fragment extends Fragment {
    ...
    public Following_Fragment(String login) {
        this.login = login;
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.activity_following__fragment, container, false);
    }
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        userViewModel.setGithubApiFollow(this.login, "following");
